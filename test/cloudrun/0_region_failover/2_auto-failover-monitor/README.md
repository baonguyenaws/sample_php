...
# Build và push image
docker build -t gcr.io/rare-karma-480813-i3/auto-failover-monitor .
docker push gcr.io/rare-karma-480813-i3/auto-failover-monitor
...
```bash
set PROJECT_ID "rare-karma-480813-i3"
...
```bash
cd monitor-service
export PROJECT_ID="rare-karma-480813-i3"
export PORT=8080
python main.py
```
...
docker build -t gcr.io/rare-karma-480813-i3/auto-failover-monitor .
docker push gcr.io/rare-karma-480813-i3/auto-failover-monitor
gcloud run deploy auto-failover-monitor --image=gcr.io/rare-karma-480813-i3/auto-failover-monitor --region=asia-northeast1
```
